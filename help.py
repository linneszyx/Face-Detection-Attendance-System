...
class Help:
    def __init__(self,root):
        ...
        dev_lbl=Label(root,text="Email: itssuryanshcooldude346@gmail.com",font=("times new roman",35,"bold"),bg="white",fg="blue")
        dev_lbl.place(x=0,y=380,width=1536,height=60)
        dev2_lbl=Label(root,text="Email: pandeyvaibhav867@gmail.com",font=("times new roman",35,"bold"),bg="white",fg="blue")
        dev2_lbl.place(x=0,y=480,width=1536,height=60)
